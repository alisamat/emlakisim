...
def create_app(env='production'):
    ...
    from .routes import auth, webhook, panel, musteri, sohbet, muhasebe, hesaplama, planlama, egitim, toplu, tanitim, lead, gelismis, bildirim, fatura, islem_takip, ofis, ekip, admin, ayarlar as ayarlar_route, grup, odeme
